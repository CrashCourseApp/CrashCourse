...
/**
 * An full-screen that shows and hides the system
 * status bar and navigation/system bar) with user interaction.
 */
public class phil35 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{

    public static final String API_KEY = "AIza5yAhQFD9ykc519_3FeL21EO2HAipQD7-Mfs";

    public static final String Video_ID = "18bIys6JoEDw";
